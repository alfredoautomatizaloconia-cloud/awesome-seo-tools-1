...
- [TinyTools](https://tinytools-smoky.vercel.app/) - Free browser-based SEO utilities including an AI robots.txt generator (manages OpenAI, Anthropic, Google AI, and other LLM crawlers), an AI content disclosure generator (EU AI Act compliant), an SEO meta tag generator, an OG image generator, and a favicon generator. No signup, all client-side, open source.
